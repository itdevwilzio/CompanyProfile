...
@section('content')
    <style>
        /* Container to make footer fixed at bottom */
        .content-wrapper {
            display: flex;
        ...
        .whatsapp-button {
            ...
            color: white;
            padding: 10px 20px; /* Adjusted padding to make it more compact */
            border-radius: 50px;
            box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.15); /* Reduced shadow size */
            font-weight: bold;
        ...
        .whatsapp-button:hover {
            ...
            transform: translateY(-2px); /* Reduced translation to make hover effect subtle */
        }
        ...
        .ck-content {
            ...
            font-size: 1.125rem; /* Text size (equivalent to 18px) */
            text-align: center; /* Align content from CKEditor in center */
        }
    </style>
            ...
            <div id="header" class="relative w-full overflow-hidden bg-[#0E3995]">
                <div class="container max-w-[1130px] mx-auto relative pt-2 z-10 main-carousel">
                    ...
                    <div class="wave-container w-full absolute top-0 left-0 z-[-1]">
                        ...
                        <svg width="100%" height="80px" id="svg" preserveAspectRatio="none" viewBox="0 0 1440 390"
                            xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150">
                            <!-- SVG paths -->
                        </svg>
                    </div>
                </div>
                <div class="text-center max-w-6xl mx-auto relative pt-20 px-4 sm:px-6 md:px-8">
                    ...
                    @if ($locations->isNotEmpty())
                        <div class="flex flex-col items-center gap-8 mb-12">
                            @foreach ($locations as $location)
                                <div class="bg-primary rounded-lg p-6 flex flex-col items-center">
                                    <!-- Center the contents -->
                                    <img src="{!! asset('storage/' . $location->image) !!}" alt="{{ $location->name }}"
                                        class="w-full max-w-[1130px] h-auto object-contain rounded-2xl mt-2 mx-auto">
                                    <!-- Larger image and centered -->
                                    <h2 class="mt-6 md:mt-10 mb-10 text-center ck-content">
                                        {!! $location->name !!}</h2>
                                    <!-- Centered and increased size of the title -->
                                    <div class="ck-content mt-6 md:mt-10">{!! $location->description !!}</div>
                                    <!-- Render CKEditor content with styling -->
                                </div>
                            @endforeach
                        </div>
                        <h1 class="text-yellow-400 font-bold text-4xl text-center mb-10">Beli Voucher Wi-Fi</h1>
                        <!-- Made the text larger and centered -->
                    @endif
                </div>

                {{-- WhatsApp Button Below Text --}}
                <div class="text-center mt-10 px-4 md:px-0 flex justify-center">
                    <a href="https://wa.me/6285179706639"
                        class="whatsapp-button flex items-center justify-center max-w-xs">
                        <i class="fab fa-whatsapp mr-2 text-lg md:text-xl"></i>
                        <span class="whitespace-nowrap">Hubungi Customer Service Wilzio</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <footer class="w-full bg-[#0E3995] text-white">
        <div class="container max-w-7xl mx-auto flex flex-col items-center justify-center py-10">
            ...
            <div class="flex items-center gap-6 mb-6">
                <!-- Social Media Icons -->
                <a href="https://www.facebook.com/official.wilzio?rdid=tlsjbpLTbIEiJvdE&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2FGjZJNGmKbkjyumXs%2F"
                    target="_blank">
                    <div
            ...
            <p class="text-sm text-white">&copy; {{ date('Y') }} wilzio.com All Rights Reserved</p>
        </div>
    </footer>
@endsection
