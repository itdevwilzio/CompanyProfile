...
@section('content')
    ...
    {{-- Section Voucher --}}
    <div class="container mx-auto flex flex-col mt-5 max-w-2xl text-white p-2">
    ...
    <footer class="w-full mt-10 bg-[#0E3995] text-white">
        <div class="container max-w-7xl mx-auto flex flex-col items-center justify-center py-10">
            ...
            <div class="flex items-center gap-6 mb-6">
                ...
                <a href="https://www.instagram.com/official.wilzio/profilecard/?igsh=MW9zazBtYjhmaGEyNg%3D%3D"
                    >
                    <div
                        class="w-10 h-10 rounded-full bg-white flex items-center justify-center transform hover:scale-110 transition-all duration-300 ease-in-out">
                        <svg class="w-5 h-5 text-[#0E3995] fill-current" xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://www.youtube.com/WIJABACKBONE">
                    <div
                        class="w-10 h-10 rounded-full bg-white flex items-center justify-center transform hover:scale-110 transition-all duration-300 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#0E3995] fill-current"
                            viewBox="0 0 24 24">
...
@push('styles')
    <style>
        .whatsapp-button {
            ...
            color: white;
            padding: 15px 40px;
            /* Increased padding for a more prominent look */
            border-radius: 50px;
            ...
            display: inline-flex;
            /* Ensures the button stays in a row format */
            align-items: center;
