    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.abouts4.update', $about4) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                        <x-input-label for="name" :value="__('Name')" />
                        <x-text-input id="name" class="block w-full mt-1" type="text" name="name"
                            value="{{ $about4->name }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="description" class="block w-full mt-1" type="text" name="description"
                                      value="{{ old('description', $about4->description) }}" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="keypoint" class="block w-full mt-1" type="text" name="keypoint"
                                      value="{{ old('keypoint', $about4->keypoint) }}" required autofocus />
